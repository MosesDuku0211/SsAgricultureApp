...
public class UsersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.activity_users_fragment, container, false);
        cartList=v.findViewById(R.id.cartList);
        mAuth=FirebaseAuth.getInstance();
        userId=mAuth.getCurrentUser().getUid();
        myCartDatabase= FirebaseDatabase.getInstance().getReference().child("Ss Agriculture App").child("Cart").child(userId);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart,CartViewHolder> adapter=new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull final CartViewHolder holder, int position, @NonNull Cart model) {
                ...
                holder.cart_tvPrice.setText("ssp :"+model.getPrice());
