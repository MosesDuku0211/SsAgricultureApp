...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v= inflater.inflate(R.layout.activity_profile_fragment, container, false);
        //FirebaseDatabase.getInstance().setPersistenceEnabled(true);

        mAuth=FirebaseAuth.getInstance();
        myProductsDatabase= FirebaseDatabase.getInstance().getReference().child("Ss Agriculture App").child("Products");

        mStorageReference= FirebaseStorage.getInstance().getReference().child("Ss Agriculture App").child("Product Images");
    ...
    public void onStart() {
        ...
        final FirebaseRecyclerAdapter<Products,productsViewHolder> adapter=new FirebaseRecyclerAdapter<Products, productsViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull productsViewHolder holder, int position, @NonNull final Products model) {
                ...
                holder.tvPrice.setText("ssp:"+model.getProduct_price());
